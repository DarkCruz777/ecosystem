...
export default defineConfig({
    // Presets
    presets: [
        presetWind3(), // Base preset with Tailwind-like utilities
        presetWebFonts({
            fonts: {
    ...
    shortcuts: {
        ...
        'btn-start':
            'bg-green text-white hover:bg-green-dark hover:shadow-md hover:translate-y--2px',
        'btn-pause':
            'bg-yellow text-white hover:bg-yellow-dark hover:shadow-md hover:translate-y--2px',
        'btn-reset':
            'bg-red text-white hover:bg-red-dark hover:shadow-md hover:translate-y--2px',
        'glass-panel':
            'bg-dark-blue/70 backdrop-blur-md border border-white/10 shadow-lg rounded-lg',
